...
if __name__ == "__main__":
    ...
    schedule.every().monday.at("09:30").do(sendMessage, client, mon_text)
    schedule.every().tuesday.at("09:30").do(sendMessage, client, tue_wed_text)
    schedule.every().wednesday.at("09:30").do(sendMessage, client, tue_wed_text)
    schedule.every().thursday.at("09:30").do(sendMessage, client, thu_text)
    schedule.every().friday.at("09:30").do(sendMessage, client, fri_text)
    # schedule.every().day.at("16:54").do(sendMessage, client, mon_text)
