...
if __name__ == "__main__":
    ...
    schedule.every().tuesday.at("09:29").do(sendMessage, client, tue_wed_text)
    schedule.every().wednesday.at("09:29").do(sendMessage, client, tue_wed_text)
